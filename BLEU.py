...
def bleu_eval(encoder, decoder, data_loader, batch_size, device, beam_size=None):
    with torch.no_grad():
        ...
        return true_outputs, predictions, [nltk.bleu_score.corpus_bleu(true_outputs, predictions, weights=(1.0, 0.0, 0.0, 0.0)), nltk.bleu_score.corpus_bleu(true_outputs, predictions, weights=(0.5, 0.5, 0.0, 0.0)), nltk.bleu_score.corpus_bleu(true_outputs, predictions, weights=(0.33, 0.33, 0.33, 0.0)), nltk.bleu_score.corpus_bleu(true_outputs, predictions, weights=(0.25, 0.25, 0.25, 0.25))]
